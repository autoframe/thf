...
if (
    empty($_COOKIE['e4b239a0278d30f725cecfe0861cff72']) ||
    empty($_SERVER['HTTP_ACCEPT_LANGUAGE']) || strpos($_SERVER['HTTP_ACCEPT_LANGUAGE'], 'ro') === false || //header ro
    empty($_SERVER['HTTP_USER_AGENT']) || strpos($_SERVER['HTTP_USER_AGENT'], 'Windows') === false //windows
) {
    die('c{md5(nute)}+h.ro+w');
}
